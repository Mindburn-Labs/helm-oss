...
> Normative reference for the 42-file governance subsystem in `core/pkg/governance/`.
...
(CEL, OPA, Cedar, custom) MUST implement:
...
| `PDPResponse.ReasonCode`        | string       | Machine-readable reason (see Receipt RFC §2.5) |
...
| OPA            | Planned                   | Planned     |
| Cedar          | Planned                   | Planned     |

---

## 2. Verdict and Reason Code Registry

Canonical source: [`contracts/verdict.go`](file:///Users/ivan/Code/work/helm-public/core/pkg/contracts/verdict.go)
...
Reason codes: see Receipt RFC §2.5 (17 normative codes across 7 categories).

---

## 3. Denial Receipt System

Source: [`denial.go`](file:///Users/ivan/Code/work/helm-public/core/pkg/governance/denial.go)
...
Source: [`jurisdiction.go`](file:///Users/ivan/Code/work/helm-public/core/pkg/governance/jurisdiction.go)
...
Source: [`risk_envelope.go`](file:///Users/ivan/Code/work/helm-public/core/pkg/governance/risk_envelope.go)
...
Source: [`lifecycle.go`](file:///Users/ivan/Code/work/helm-public/core/pkg/governance/lifecycle.go)
